...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("แอพความรู้เกี่ยวกับ Raspberry Pi"),
        ),
        body: Padding(
  ...
  Future getData() async {
    //https://raw.githubusercontent.com/Teeforest16/BasicAPI/main/data.json
    var url = Uri.https('raw.githubusercontent.com','/Teeforest16/BasicAPI/main/data.json');
